...
public class MyOffer {
    ...
    public static void main(String[] args) {
        ...
        offer3.setInfo("IL", "Apple Inc", "Developer", 130000, true,
                true, true, false );

        Offer offer4 = new Offer();
        offer4.setInfo("TX", "CapitalOne Inc", "SM", 115000, false,
                false, true, true );

        Offer offer5 = new Offer();
        offer5.setInfo("WA", "BankOfAmerica Inc", "BA", 131000, true,
                true, false, true );
        ...
        fullTimeOffers.removeIf( p -> !p.isFullTime ); // removes if offer is not full time

        System.out.println(fullTimeOffers.size());

        ArrayList<Offer> localOffers = new ArrayList<>(Arrays.asList(myOffers));
        localOffers.removeIf(p -> !p.location.equals("VA")); // removes if offer NOT from Local Area
